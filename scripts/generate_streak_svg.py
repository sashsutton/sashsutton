...
USER = sys.argv[1] if len(sys.argv) > 1 else "sashsutton"
...
<style>
  ...
  /* the graph is drawn on the README's own background, so the summary line and
     the empty cells have to follow the reader's github theme -- otherwise
     near-white text and near-black cells vanish in light mode. */
